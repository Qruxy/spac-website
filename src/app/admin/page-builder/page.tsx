...
const PAGES: PageDef[] = [
  {
    ...
    fields: [
      ...
      { key: 'newsletter_cover_url', label: 'Newsletter — Cover Photo URL', hint: 'Upload the cover of the latest SPACE issue and paste its URL here. Shown on the homepage above the gallery section.', type: 'image', section: 'Newsletter Section (Homepage)' },
      { key: 'newsletter_drive_url', label: 'Newsletter — Google Drive Link', hint: 'Direct link to the latest issue on Google Drive. The cover photo will link to this URL.', type: 'text', placeholder: 'https://drive.google.com/...', maxLength: 500, section: 'Newsletter Section (Homepage)', defaultValue: 'https://drive.google.com/drive/folders/0B9dsr9BUsMaYSnkxZ0E1SFBHbTQ?usp=sharing' },
      { key: 'newsletter_issue_label', label: 'Newsletter — Issue Label', hint: 'Label shown below the cover photo, e.g. "April 2026 Issue"', type: 'text', placeholder: 'Current Issue', maxLength: 60, section: 'Newsletter Section (Homepage)', defaultValue: 'Current Issue' },
      { key: 'newsletter_tagline', label: 'Newsletter — Tagline', hint: 'Short description below the SPACE title on the homepage.', type: 'textarea', placeholder: 'Our monthly newsletter — club news, observing reports, and celestial previews.', maxLength: 200, section: 'Newsletter Section (Homepage)', defaultValue: 'Our monthly newsletter — club news, observing reports, and celestial previews.' },
  ...
  },
  {
    ...
    href: '/newsletter',
    description: 'Archive of SPACE — the St. Petersburg Astronomy Club Examiner.',
    icon: Mail,
    fields: [
      { key: 'hero_subtitle', label: 'Page Subtitle', hint: 'A short description below the SPACE title on the newsletter archive page.', type: 'textarea', placeholder: 'Explore our archive of monthly newsletters...', maxLength: 200, section: 'Page Header', defaultValue: 'Explore our archive of monthly newsletters featuring club news, observing reports, member articles, and celestial event previews.' },
      { key: 'cover_photo_url', label: 'Cover Photo — Latest Issue', hint: 'Upload the cover page of the current SPACE issue. Appears above "Complete Archive on Google Drive".', type: 'image', section: 'Current Issue Cover' },
      { key: 'cover_drive_url', label: 'Cover Photo — Google Drive Link', hint: 'The cover photo will link to this URL (Google Drive direct link to the latest issue PDF).', type: 'text', placeholder: 'https://drive.google.com/file/d/...', maxLength: 500, section: 'Current Issue Cover', defaultValue: 'https://drive.google.com/drive/folders/0B9dsr9BUsMaYSnkxZ0E1SFBHbTQ?usp=sharing' },
      { key: 'cover_issue_label', label: 'Cover Photo — Issue Label', hint: 'Text shown below the cover image, e.g. "April 2026 Issue"', type: 'text', placeholder: 'Latest Issue', maxLength: 60, section: 'Current Issue Cover', defaultValue: 'Latest Issue' },
    ],
  },
  {
    key: 'contact',
