...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'Sample 1' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Sample 2' },
      { image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Sample 3' },
    ];
...
export function CircularGallery({
  ...
  return <div className={`${styles.circularGallery} ${className}`} ref={containerRef} />;
}
