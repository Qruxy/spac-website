 ...
 *
 * A scrollable list with entrance animations and keyboard navigation.
    ...
    <div className={`relative w-full ${className}`}>
      ...
      {showGradients && (
        <>
          ...
          />
          <div
            className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-background to-transparent pointer-events-none transition-opacity duration-300"
